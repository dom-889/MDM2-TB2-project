...
if __name__ == "__main__":
    ...
    if not os.path.exists("test_images/big_john.jpg"):
        import shutil
        shutil.copy("big_john.jpg", "test_images/big_john.jpg")
    ...
    ax[0].imshow(cv.cvtColor(cv.resize(cv.imread("test_images/big_john.jpg"), (64, 64)), cv.COLOR_BGR2RGB))
    ax[0].set_title("Original image")
    ax[0].axis('off')

    ax[1].imshow(A, cmap='gray', aspect='auto')
