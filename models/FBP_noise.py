...
fig_imgs, axes_imgs = plt.subplots(2, len(sigmas), figsize=(3*len(sigmas), 6))
...
for i, sigma in enumerate(sigmas):
    ...
    axes_imgs[0,i].text(0.5, -0.1, f'Noise Std Dev: {sigma}', ha='center', va='center', transform=axes_imgs[0,i].transAxes)
    ...
    axes_imgs[1,i].text(0.5, -0.1, f'RMSE: {best_rmse:.4f}, Window Iterations: {optimal_w_iter}, Window Strength: {optimal_w_str}', 
